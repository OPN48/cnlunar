...
def getLunar(now):
    ...
    # print(a.twohour8CharList)
    # print(a.day8Char,a.twohour8Char)
    return dic
# i=1
# c=0
# now = datetime.datetime(1996, 12, 24, 12, 30)
# while i <= 100:
#     a = lunar.Lunar(now)
#     print(now.year,a.thisYearSolarTermsDic)
#     print(a.nextSolarTermYear, a.nextSolarTerm, a.nextSolarTermDate)
