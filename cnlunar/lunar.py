...
class Lunar:
    ...
    def get_AngelDemon(self):
        ...
        angel = [
            ...
            # 《三僚大通书》岁德、岁德合：年天干对日天干['修造','动土','嫁娶','纳采','移徙','入宅','百事皆宜'] 天干相合+5  20190206
        ...
        demon = [
            ...
            # 《钦定协纪辨方书》卷四：“破为岁破，为大耗，大凶。”大耗与月破同为月建之冲（破日）。
            ('大耗', '午未申酉戌亥子丑寅卯辰巳'[men], d, [], ['修仓库', '开市', '立券交易', '纳财', '开仓']),
            ...
            # 卷四：“执为四利之死符，又为小耗。”故小耗为执日，即相对月建顺移五辰。
            ('小耗', '巳午未申酉戌亥子丑寅卯辰'[men], d, [], ['修仓库', '开市', '立券交易', '纳财', '开仓']),
